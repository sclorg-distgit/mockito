...
%{?scl:scl enable %{scl_maven} %{scl} - << "EOF"}
set -e -x
build-jar-repository lib/compile objenesis cglib-3 junit hamcrest/core
ant jar javadoc
...
%changelog
* Wed Jul 20 2016 Mat Booth <mat.booth@redhat.com> - 1.10.19-10.2
- Fix reference to cglib compat package
- Set OSGi version properly
- Fix unowned directories

* Wed Jul 20 2016 Mat Booth <mat.booth@redhat.com> - 1.10.19-10.1
